...
assign line_0_block_06_match = line_0_valid_match & line_0_block[6];
assign line_0_block_05_match = line_0_valid_match & line_0_block[5];
assign line_0_block_04_match = line_0_valid_match & line_0_block[4];
assign line_0_block_03_match = line_0_valid_match & line_0_block[3];
assign line_0_block_02_match = line_0_valid_match & line_0_block[2];
assign line_0_block_01_match = line_0_valid_match & line_0_block[1];
assign line_0_block_00_match = line_0_valid_match & line_0_block[0];

assign line_1_block_07_match = line_1_valid_match & line_1_block[7];
assign line_1_block_06_match = line_1_valid_match & line_1_block[6];
assign line_1_block_05_match = line_1_valid_match & line_1_block[5];
assign line_1_block_04_match = line_1_valid_match & line_1_block[4];
assign line_1_block_03_match = line_1_valid_match & line_1_block[3];
assign line_1_block_02_match = line_1_valid_match & line_1_block[2];
assign line_1_block_01_match = line_1_valid_match & line_1_block[1];
assign line_1_block_00_match = line_1_valid_match & line_1_block[0];

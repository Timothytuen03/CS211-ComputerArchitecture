...
void recursiveMatTrans (
    ...
    if (n<=2) { // base case - OG = 32
        ...
        /* ... */
        recursiveMatTrans( global_n, n>>1, A, offset_row_A, offset_col_A+offset, B, offset_row_B+offset, offset_col_B);
        /* ... */
        recursiveMatTrans( global_n, n>>1, A, offset_row_A+offset, offset_col_A, B, offset_row_B, offset_col_B+offset);
        /* ... */
        recursiveMatTrans( global_n, n>>1, A, offset_row_A+offset, offset_col_A+offset, B, offset_row_B+offset, offset_col_B+offset);
    }
}
